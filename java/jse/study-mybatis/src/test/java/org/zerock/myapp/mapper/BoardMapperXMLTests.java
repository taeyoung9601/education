...
//	Params params = new Params(3, "LE_1"); //@Value (VO)
...
//	@Value	//READ - ONLY
	...
	void insertBoard() throws SQLException {
		...
		String mappedStatement = "%s.%s".formatted("TaeMapper", "insertBoard");
		
//		Caused by: java.sql.SQLException: ORA-17004: 열 유형이 부적합합니다.: 1111
		// 위 오류가 발생하면, 무조건 바인드 변수에 제대로 바인딩 값을 전달하지 못했구나!! 라고
		// 생각하시면 됩니다.
...
//		params.put("writer", "Tae");
		
//		Params params = new Params(null,"New Title","New Content","Tae");		// @Data (DTO)
		Params params = new Params();
		params.setTitle("New Title");
		params.setContent("New Content");
		params.setWriter("Tae");
