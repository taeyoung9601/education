...
-- 직책이 IT_PROG인 사원의 월급보다 *작은* 월급여를 받는 사원정보 조회
SELECT
    last_name,
    department_id,
    salary
...
-- 직책이 IT_PROG인 사원의 월급보다 *많은* 급여를 받는 사원정보 조회
SELECT
    last_name,
    department_id,
    salary
...
-- 직책이 IT_PROG인 사원의 *최소* 급여보다 *큰* 급여를 받는 사원조회
SELECT
    last_name,
    department_id,
    salary
...
-- 직책이 IT_PROG인 사원의 *최대* 급여보다 *작은* 급여를 받는 사원조회
SELECT
    last_name,
    department_id,
    salary
